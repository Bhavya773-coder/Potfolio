...
const AboutMeLazy = lazy(() => import('./components/AboutMe'));
const ProjectsLazy = lazy(() => import('./components/Projects'));
const ExperienceLazy = lazy(() => import('./components/Experience'));
const CertificatesLazy = lazy(() => import('./components/Certificates'));
const ContactMeLazy = lazy(() => import('./components/ContactMe'));
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-[#0a192f]">
        ...
        {/* Projects Section */}
        <section id="Projects" className="w-full min-h-[80vh] py-20 px-4 sm:px-8 md:px-16 lg:px-24">
          <div className="max-w-[1400px] mx-auto">
        ...
        {/* Experience Section */}
        <section id="Experience" className="w-full min-h-[80vh] py-20 px-4 sm:px-8 md:px-16 lg:px-24">
          <div className="max-w-[1400px] mx-auto">
        ...
        <section id="Certificates" className="w-full min-h-[80vh] py-20 px-4 sm:px-8 md:px-16 lg:px-24">
          <div className="max-w-[1400px] mx-auto">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 bg-gradient-to-r from-[#5BA4FC] via-[#A495FD] to-[#E975FF] text-transparent bg-clip-text">
              Certificates
            </h2>
        ...
        {/* Contact Section */}
        <section id="Contact" className="w-full min-h-[80vh] py-20 px-4 sm:px-8 md:px-16 lg:px-24">
  <div className="max-w-[1400px] mx-auto">
    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-[#5BA4FC] via-[#A495FD] to-[#E975FF] text-transparent bg-clip-text">
      Get In Touch
    </h2>
